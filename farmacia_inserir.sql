...
DELIMITER //
CREATE PROCEDURE inserir_cliente(IN idCliente INT, IN Nome VARCHAR(60), IN NIF VARCHAR(9), IN Telemovel VARCHAR(20),
			IN eMail VARCHAR(45), IN Pass VARCHAR(30), IN Cidade VARCHAR(30), IN CodigoPostal VARCHAR(45), IN Rua VARCHAR(50))
